/* The code below may recycle some fragments from: Christian Starkjohann, 2008-04-10, GNU GPL v2 license

General Description:

This is the host-side driver for the custom-class example device. It searches
the USB for the device and sends the requests understood by this device.
